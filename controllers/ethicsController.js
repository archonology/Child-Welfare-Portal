...
module.exports = {
    ...
    getResources(req, res) {
        Ethics.find()
            .then(async (resources) => {
                const resourceObj = {
                    resources,
                    ethicsResourceCount: await resourceCount(),
                };
    ...
    getOneResource(req, res) {
        Ethics.findOne({ _id: req.params._id })
            .select('-__v')
            .lean()
            .then(async (resource) =>
                !resource
    ...
    deleteResource(req, res) {
        ...
        Ethics.findOneAndRemove({ _id: req.params._id })
            .then((resource) =>
                !resource
