...
module.exports = {
    ...
    getResources(req, res) {
        Interviewing.find()
            .then(async (resources) => {
                const resourceObj = {
                    resources,
                    interviewingResourceCount: await resourceCount(),
                };
    ...
    getOneResource(req, res) {
        Interviewing.findOne({ _id: req.params._id })
            .select('-__v')
            .lean()
            .then(async (resource) =>
                !resource
    ...
    deleteResource(req, res) {
        ...
        Interviewing.findOneAndRemove({ _id: req.params._id })
            .then((resource) =>
                !resource
