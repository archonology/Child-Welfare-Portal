...
module.exports = {
    ...
    getResources(req, res) {
        CpLaw.find()
            .then(async (resources) => {
                const resourceObj = {
                    resources,
                    CpLawResourceCount: await resourceCount(),
                };
    ...
    getOneResource(req, res) {
        CpLaw.findOne({ _id: req.params._id })
            .select('-__v')
            .lean()
            .then(async (resource) =>
                !resource
    ...
    deleteResource(req, res) {
        ...
        CpLaw.findOneAndRemove({ _id: req.params._id })
            .then((resource) =>
                !resource
