...
module.exports = {
    ...
    getResources(req, res) {
        FosterCare.find()
            .then(async (resources) => {
                const resourceObj = {
                    resources,
                    fosterCareResourceCount: await resourceCount(),
                };
    ...
    getOneResource(req, res) {
        FosterCare.findOne({ _id: req.params._id })
            .select('-__v')
            .lean()
            .then(async (resource) =>
                !resource
    ...
    deleteResource(req, res) {
        ...
        FosterCare.findOneAndRemove({ _id: req.params._id })
            .then((resource) =>
                !resource
