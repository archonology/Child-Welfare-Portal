...
module.exports = {
    ...
    getResources(req, res) {
        Ssis.find()
            .then(async (resources) => {
                const resourceObj = {
                    resources,
                    ssisResourceCount: await resourceCount(),
                };
    ...
    getOneResource(req, res) {
        Ssis.findOne({ _id: req.params._id })
            .select('-__v')
            .lean()
            .then(async (resource) =>
                !resource
    ...
    deleteResource(req, res) {
        ...
        Ssis.findOneAndRemove({ _id: req.params._id })
            .then((resource) =>
                !resource
