...
module.exports = {
    ...
    getResources(req, res) {
        MentalHealth.find()
            .then(async (resources) => {
                const resourceObj = {
                    resources,
                    mentalHealthResourceCount: await resourceCount(),
                };
    ...
    getOneResource(req, res) {
        MentalHealth.findOne({ _id: req.params._id })
            .select('-__v')
            .lean()
            .then(async (resource) =>
                !resource
    ...
    deleteResource(req, res) {
        ...
        MentalHealth.findOneAndRemove({ _id: req.params._id })
            .then((resource) =>
                !resource
