...
module.exports = {
    ...
    getResources(req, res) {
        DataPrivacy.find()
            .then(async (resources) => {
                const resourceObj = {
                    resources,
                    dataPrivacyResourceCount: await resourceCount(),
                };
    ...
    getOneResource(req, res) {
        DataPrivacy.findOne({ _id: req.params._id })
            .select('-__v')
            .lean()
            .then(async (resource) =>
                !resource
    ...
    deleteResource(req, res) {
        ...
        DataPrivacy.findOneAndRemove({ _id: req.params._id })
            .then((resource) =>
                !resource
